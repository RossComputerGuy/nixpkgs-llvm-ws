# Copy from https://github.com/ajs124/nixpkgs/blob/2b39c90d97e302d0edb95b4025ea0b4f792a6c75/pkgs/os-specific/linux/apparmor/default.nix
# until https://nixpk.gs/pr-tracker.html?pr=304753 reaches nixos-unstable
...
let
  ...
  patches = [
    "${pkgs.path}/pkgs/os-specific/linux/apparmor/0001-aa-remove-unknown_empty-ruleset.patch"
